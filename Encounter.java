...
public class Encounter {
    ...
    public static void email(Ship player)//email
    {
        Main.clearScreen();
    ...
    public static void libOrSea(Ship player)
    {
    ...
    public static void library(Ship player) {
        Main.clearScreen();
        ...
        libraryResponse(player);
    }
    public static void libraryResponse(Ship player){
